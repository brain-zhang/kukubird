...
def get_comic_url_by_comicid(comic_id = 1, vol = 1, capture = -1):    
    try:
        ...
        get_comic_url_by_comicid(comic_id, vol, capture)
...
def download_by_aka_name(aka_name, dir = 'd:/comic/down_comic/nginx/html/'):
...
if __name__ == '__main__':
    ...
    #akaname = args[0].decode('GB2312')
    reload(sys)
    sys.setdefaultencoding('utf8')
    download_by_aka_name(u'海贼王')
